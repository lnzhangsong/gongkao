...
> - **定宽修订（两轮，按用户反馈）**：① 六列由 flex 改栅格、柱子由「列宽的 60%」改固定 26px；② 整块谱系加 `max-width: 560px`——第一轮只钉死了柱子，列宽仍是 `1fr`、仍随面板等分伸缩（用户两张截图实测：窗口 2746→2146px 时列宽 323→287px），第二轮才把整块固定。实测面板 1244 / 900 / 600px → 谱系恒 560px、列宽恒 88px；仅在面板窄于 560px 时按比例缩。
