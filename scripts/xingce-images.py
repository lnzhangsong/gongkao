...
import pymupdf
from xingce_common import QNUM_RE_2026, ZOOM, build_index, cut_ad, cut_leak, page_lines, png_to_webp, question_chain, safe_paper_dir, trimmed_png, write_image_files
...
def process(json_path: Path, paper_pdf: Path, ans_pdf: Path, img_dir: Path = DEFAULT_IMG_DIR, answers_only: bool = False):
    ...
    chain = question_chain(lines, max_q + 1, qnum_re=QNUM_RE_2026)
